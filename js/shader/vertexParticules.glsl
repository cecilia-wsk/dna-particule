...
float clampy(float value, float minVal, float maxVal) {
...
void main() {
    ...
    //newPos.y *= clampy(1., 0., (cos(uTime*.2)-offset));
    //newPos.y += clampy(1., 0., (cos(uTime*.2)-offset));

    //newPos.y += clampy(1., 0., (1. - uProgress-offset));

    // y goes up and down
    //newPos.y += clamp(0., 1., cos(uTime*0.2) );
